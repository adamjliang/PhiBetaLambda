            ...
            InkWell(
              onTap: () {
                ...
                for (int i = 0; i < finish; i++){
                  if ((snapshot.data.documents[i]['Username'] == globals.inputUsername && 
                  snapshot.data.documents[i]['Password'] == globals.inputPassword)){
                    globals.refreshLogin = true;
                    globals.firstName = snapshot.data.documents[i]['First Name'];
                    globals.lastName = snapshot.data.documents[i]['Last Name'];
                    globals.level = snapshot.data.documents[i]['Clearance'];
                    globals.username = snapshot.data.documents[i]['Username'];
